  ...
  head: () => ({
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
       { title: "Mom's Kitchen" },
       { name: "description", content: "Fresh, comforting homestyle meals from Mom's Kitchen." },
       { name: "author", content: "Mom's Kitchen" },
       { property: "og:title", content: "Mom's Kitchen" },
       { property: "og:description", content: "Fresh, comforting homestyle meals from Mom's Kitchen." },
